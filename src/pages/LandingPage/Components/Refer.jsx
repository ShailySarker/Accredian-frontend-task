import cover1 from '../../../assets/Image/LandingPage/Refer_cover1.png';
import cover2 from '../../../assets/Image/LandingPage/Refer_cover2.png';
import step1 from '../../../assets/Image/LandingPage/Refer_step1.png';
import step2 from '../../../assets/Image/LandingPage/Refer_step2.png';
import step3 from '../../../assets/Image/LandingPage/Refer_step3.png';

const Refer = () => {
    return (
        <div className='xl:px-24 lg:px-16 md:px-10 px-5 bg-[#EEF5FF] xl:py-10 lg:py-7 md:py-5 py-4 flex flex-col justify-center items-center lg:mb-0 md:mb-14 mb-12'>
            ...
            <div className='w-full xl:mt-12 lg:mt-10 md:mt-7 mt-5 relative'>
                ...
                <div className='grid md:grid-cols-3 md:grid-rows-none grid-rows-3 grid-cols-none absolute inset-0'>
                    <div className='flex flex-col justify-center items-center mx-auto xl:gap-5 lg:gap-4 md:gap-3 gap-4 xl:px-20'>
                        <img className='xl:w-14 lg:w-12 md:w-10 w-12' src={step1} alt="step1" />
                    ...
                    <div className='flex flex-col justify-center items-center mx-auto xl:gap-5 lg:gap-4 md:gap-3 gap-4 xl:px-20'>
                        <img className='xl:w-14 lg:w-12 md:w-10 w-12' src={step2} alt="step2" />
                    ...
                    <div className='flex flex-col justify-center items-center mx-auto xl:gap-5 lg:gap-4 md:gap-3 gap-4 xl:px-20'>
                        <img className='xl:w-14 lg:w-12 md:w-10 w-12' src={step3} alt="step3" />
            ...
            <button className='bg-[#1A73E8] xl:py-[10px] lg:py-2 py-[6px] text-white rounded-md xl:px-12 lg:px-10 md:px-8 px-6 font-medium xl:text-base lg:text-[15px] md:text-[14.5px] text-sm xl:mt-10 lg:mt-7 md:mt-6 mt-5'>Refer Now</button>
        </div>
    );
};
